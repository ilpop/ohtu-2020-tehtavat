...
public class Sovellus {
    ...
    private static IntJoukko mihinJoukkoon() {               
    ...
    private static void lisaa() {
        mihinJoukkoon().lisaa(mikaLuku());     
        return;

    }
    
    private static IntJoukko aJoukko() {   
    ...
    private static IntJoukko bJoukko() {          
